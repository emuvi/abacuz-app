...
class Abacuz extends qinpel_cps_1.QinColumn {
    constructor() {
        ...
        this.qinLoad = new qinpel_cps_1.QinButton({
            icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceRedo, qinpel_res_1.QinGrandeur.SMALL),
        });
        this.qinUp = new qinpel_cps_1.QinButton({
            icon: new qinpel_cps_1.QinIcon(qinpel_cps_1.QinAsset.FaceArrowUp, qinpel_res_1.QinGrandeur.SMALL),
        });
...
},{"qinpel-cps":2,"qinpel-res":23}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
